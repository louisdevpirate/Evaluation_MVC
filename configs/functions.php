...
// Fonction qui permettra d'autocharger les fichiers contenant les classes PHP (dans le dossier "src" qui se trouve un cran plus haut dans l'arborescence, d'où les "..")
function call($className){

    // Emplacement du dossier des classes de notre site (src)
